...
public class Administration extends User {
	...
	public Administration(String id, String firstName, String middleName, String lastName, Role role,
		...
		super(id, firstName, middleName, lastName, role, contactNumber, status, createdAt, createdBy, department, username, userPassword, updatedBy, updatedDt);
