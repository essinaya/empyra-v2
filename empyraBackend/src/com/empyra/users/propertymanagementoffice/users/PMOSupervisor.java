...
public class PMOSupervisor extends PropertyManagementOffice {

	public PMOSupervisor(String id, String firstName, String middleName, String lastName, Role role,
