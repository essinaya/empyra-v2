package com.empyra.users.propertymanagementoffice;

import com.empyra.users.User;
import com.empyra.utils.Department;
import com.empyra.utils.Role;

public class PropertyManagementOffice extends User {

	public PropertyManagementOffice(String id, String firstName, String middleName, String lastName, Role role,
